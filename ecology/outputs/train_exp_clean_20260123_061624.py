...
DATA_PATH = Path("/lambda/nfs/ecology/Semantic-Duplicates-Main-Repo/ecology/data/clean/train_clean.json")
OUTPUT_DIR = Path("/lambda/nfs/ecology/Semantic-Duplicates-Main-Repo/ecology/outputs") / "exp_clean_20260123_061624"
