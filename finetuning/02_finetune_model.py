...
data_path = "/workspace/nicky/MuSR/nicky3/murder_mystery_regenerated_first173.json"
answers_path = "/workspace/nicky/MuSR/nicky3/answered_murder_mystery_questions_gpt41mini.jsonl"

# Training mode
TRAIN_ON_ANSWERS = True  # If True, train on instruction-following format with Q&A
TRAIN_ONLY_ON_OUTPUTS = True  # If True, compute loss only on model outputs (assistant responses), not inputs
