...
def main(
    ...
    if output_path is None:
        output_path = Path(__file__).parent.parent / 'datasets' / 'teacher_answers' / 'musr' / f"{str(input_path).split('/')[-1]}_{MODEL_SHORT}.jsonl"
...
if __name__ == "__main__":
    default_input_path = Path(__file__).parent.parent / 'datasets' / 'duplicates' / "musr" / "level0_murder_mystery_regenerated_samples-250_variants-2.json"
