#!/usr/bin/env python3
"""
Evaluate checkpoints from train_all_kl_fixed.py.
Uses the same format as eval_all.py but points to checkpoints_fixed directory.

Usage:
    accelerate launch --num_processes 8 eval_all_fixed.py
"""
...
CHECKPOINT_DIR = OUTPUT_DIR / "checkpoints_fixed"  # Points to fixed checkpoints
RESULTS_FILE = OUTPUT_DIR / "eval_results_fixed.json"
